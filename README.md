...
| **[금융 데이터 MCP 서버](./mcp/)** | 한국 금융 공공데이터 MCP 서버 9종·도구 67개를 Cloud Run에 배포하고 Gemini Enterprise에 연결 | ⭐⭐⭐ | MCP, FastMCP, Cloud Run, Terraform, Gemini Enterprise | [📖 가이드](./mcp/README.md) |
