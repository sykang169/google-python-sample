...
| **[금융 데이터 MCP 서버](./mcp/)** | 한국 금융 공공데이터 MCP 서버 9종·도구 66개를 Cloud Run에 배포하고 Gemini Enterprise에 연결 | ⭐⭐⭐ | MCP, FastMCP, Cloud Run, Terraform, Gemini Enterprise | [📖 가이드](./mcp/README.md) |
| **[금융권 Agent Skills](./skills/)** | 국내 금융 도메인 Agent Skills 8종 — 업무 5(주식분석·금리·기업재무·상품비교·권리업무) + 횡단 3(캘린더·식별자·규제) | ⭐⭐☆ | Agent Skills, Gemini Enterprise, Antigravity, Gemini CLI, Claude Code | [📖 가이드](./skills/README.md) |
