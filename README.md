...
| **[금융권 Agent Skills](./skills/)** | 국내 금융 도메인 Agent Skills 9종 — 업무 5(주식분석·금리·기업재무·상품비교·권리업무) + 횡단 3(캘린더·식별자·규제) | ⭐⭐☆ | Agent Skills, Gemini Enterprise, Antigravity, Gemini CLI, Claude Code | [📖 가이드](./skills/README.md) |
