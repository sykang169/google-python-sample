...
| **[금융권 Agent Skills](./skills/)** | 국내 금융 도메인 Agent Skills 11종 — 데이터 8(시세·채권·기업분석·권리업무·업계·DART·ECOS·상품) + 횡단 3(캘린더·식별자·규제) | ⭐⭐☆ | Agent Skills, Gemini Enterprise, Claude Code | [📖 가이드](./skills/README.md) |
